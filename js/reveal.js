...
(function(root, factory) {
  ...
  function createBackground(slide, container) {
    ...
    var twitterElement = document.createElement("div");
    twitterElement.className = "twitter";
    var twitterLink = document.createElement("a");
    twitterLink.setAttribute("href", "https://twitter.com/LittleKope");
    twitterLink.innerText = "@LittleKope";
    twitterElement.appendChild(twitterLink);
    // <div class="twitter">
    // 	<a href="https://twitter.com/LittleKope">@LittleKope</a>
    // </div>
    element.appendChild(contentElement);
    element.appendChild(twitterElement);
